...
knitr_fig_path("01-")
knitr::opts_chunk$set(fig.align = "left", echo = FALSE, message = FALSE, warning = FALSE, fig.alt = "")
```
...
```{r, out.width="50%"}
knitr::include_graphics("../fig/01-minion-mk1d.png")
```
...
```{r, out.width="50%", fig.align="center"}
knitr::include_graphics("../fig/01-ont-accurarcy-1.png")
```

<BR> 

```{r, out.width="50%", fig.align="center"}
knitr::include_graphics("../fig/01-ont-accurarcy-2.png")
```
...
```{r, out.width="50%", fig.align="center"}
knitr::include_graphics("../fig/01-ont-simplex-q20.png")
```
...
knitr::include_graphics("../fig/01-lc23.png")
```
