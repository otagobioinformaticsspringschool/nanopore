...
bedCov = read.table('../files/yog-as-100kb-chunks-10k-cov.txt', header=FALSE, sep='\t')
```
...
```{r, eval=TRUE, echo=FALSE}
bedCovSelected = read.table('../files/yog-as-100kb-chunks-SELECTED-cov.txt', header=FALSE, sep='\t')
```
